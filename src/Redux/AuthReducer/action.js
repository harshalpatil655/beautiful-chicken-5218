...
export const account = (payload)=>(dispatch)=>{
   ...
   return axios.post("https://gentle-escarpment-82476.herokuapp.com/register",payload,axiosConfig).then((r)=>{
...
export const login = (payload)=>(dispatch)=>{
   ...
   return axios.post("https://gentle-escarpment-82476.herokuapp.com/login",payload,axiosConfig).then((r)=>{
