    ...
    <Box width={"100%"} marginTop={"40px"}>
      <Flex justifyContent={"space-around"}> 
        <Box width={"30%"} height="300px">
          <Box>
          <Text  fontSize={"15px"}>Get email offers & the latest news from Bath & Body Works!</Text>
          <Text textAlign={"initial"}>Enter Email</Text>
          <Input borderRadius={"0px"}></Input>
          <Text textAlign={"initial"} marginTop="20px">Enter Confirm Email</Text>
          ...
          <Box marginTop="20px">
            <Heading textAlign={"initial"} fontSize={"sm"}>GET CONNECTED</Heading>
            <Flex gap={"10px"} >
            <AiFillTwitterCircle style={{height:"30px",width:"30px"}} /><BsInstagram  style={{height:"30px",width:"30px"}}  ></BsInstagram > <BsFacebook style={{height:"30px",width:"30px"}}  /> 
            <AiFillYoutube style={{height:"30px",width:"30px"}} ></AiFillYoutube>
            </Flex>
          </Box>
        </Box>
         <Box width={"15%"} height="300px">
          <Stack direction="column" gap="10px">
            <Heading as={"h1"} fontSize="20px" textAlign={"initial"}>Customer Care</Heading>
        ...
        <Box width={"15%"} height="300px" >
          <Stack direction="column" gap="10px">
            <Heading textAlign={"initial"} as={"h1"} fontSize="20px">My account</Heading>
        ...
        <Box width={"15%"} height="300px">
          <Stack direction="column" gap="10px">
            <Heading textAlign={"initial"} as={"h1"} fontSize="20px">Discover</Heading>
        ...
        <Box width={"15%"} height="300px">
          <Stack direction="column" gap="10px">
            <Heading textAlign={"initial"} as={"h1"} fontSize="20px">Find Us</Heading>
            <Text textAlign={"initial"}> Store Locator</Text>
            <Text textAlign={"initial"}> Global Locations</Text>
          </Stack>
        </Box>
      </Flex>
      <img style={{marginLeft:"68%"}} height={"200px"} width="400px" src="https://cdn-fsly.yottaa.net/5d669b394f1bbf7cb77826ae/www.bathandbodyworks.com/v~4b.216/on/demandware.static/-/Sites-BathAndBodyWorks-Library/default/dw0c8e6af7/images/evergreen/Happiness_Guaranteedtimes2_v2.jpg?yocs=o_s_" alt="" />
    </Box>
